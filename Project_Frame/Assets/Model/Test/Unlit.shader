Shader "GM5/Unlit"
{
    Properties
    {
        ...
        //_SkyColor("Base Color", Color) = (0.5, 0.5, 0.5, 1)
    ...
    SubShader
    {
        Tags
        {
            "RenderType" = "Opaque" "IgnoreProjector" = "True" "RenderPipeline" = "UniversalPipeline" "ShaderModel"="4.0"
        }
        LOD 100
    ...
    CustomEditor "UnityEditor.GM5.Rendering.Universal.ShaderGUI.UnlitShader"
}